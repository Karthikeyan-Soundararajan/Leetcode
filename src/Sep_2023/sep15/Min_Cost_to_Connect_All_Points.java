...
public class Min_Cost_to_Connect_All_Points {
    ...
    public static void main(String[] args) {
        Min_Cost_to_Connect_All_Points minCostToConnectAllPoints = new Min_Cost_to_Connect_All_Points();
        System.out.println(minCostToConnectAllPoints.minCostConnectPoints(new int[][]{{0,0},{2,2},{3,10},{5,2},{7,0}}));
    }
}
